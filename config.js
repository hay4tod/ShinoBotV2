...
global.mods = []
global.prems = []
global.nomorbot = '6285770866730'
global.nameown = 'Yuu'
global.nomorown = '62895404440700'
global.nomorown1 = '62895404440700'
global.nomorown2 = '62895404440700'
global.nomorwa = '0'
global.limitawal = {
...
global.author = 'Yuu' //ganti aja cuyyy
global.namebot = '​Shino • Bot' //nama bot luh
global.wm = 'Yuu' //ganti aja
global.media = 'https://telegra.ph/file/5d45a3d1e12726d98c5e4.jpg' //bebas
global.wm = 'Shino • Bot ' //wm nyaa kocak
global.watermark = wm //bebas
global.wm2 = 'Yuu' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = `Shino • Bot | Yuu` //gantu aja
global.stickpack = 'Shino' //ganti 
global.stickauth = `Bot` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'Yuanda' //ganti 
global.nameown2 = 'Yuu' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.Linkgc = 'Tunggu Sebentar Kak...'
global.lynk = 'https://chat.whatsapp.com/F8r8aVeEl7PAiQyAmzIrmr'//ganti jadi link gc luh


//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA SOSSIAL ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = 'https://instagram.com/yuuanda_' //ganti jadi ig mu
global.sgh = 'https://github.com/hay4tod' //github
global.sgc = 'https://chat.whatsapp.com/F8r8aVeEl7PAiQyAmzIrmr' //group whatsapp
global.sdc = 'https://discord.gg/hYAbJszBvC' //discord klo ga punya ga usah biarin aja
